...
class ApplicationMain {
	...
	public static function main () {
		...
		config = {
			...
			build: "1",
			company: "",
			file: "SearchAndReplace",
			fps: 60,
			name: "SearchAndReplace",
			orientation: "",
			packageName: "vimStudio",
			version: "1.0.0",
			windows: [
		...
		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed (null, 350, 280, "null");
		#end
		#else
		create ();
		#end
	...
	public static function start ():Void {
		...
		var hasMain = false;
		var entryPoint = Type.resolveClass ("vimStudio.Main");
...
@:keep class DocumentClass extends vimStudio.Main {}
